    ...
    <footer id="contact" className="py-24 px-6 md:px-8">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mt-10 max-w-xl">
          <a href={`mailto:${CONTACT.email}`} className="flex items-center gap-3 text-sm" style={{ color: C.text }}>
            <Mail size={16} color={C.accent} /> {CONTACT.email}
          </a>
          <a href={`tel:${CONTACT.phoneHref}`} className="flex items-center gap-3 text-sm" style={{ color: C.text }}>
